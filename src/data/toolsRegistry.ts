...
export const TOOLS: ToolDefinition[] = [
  ...
  },
  {
    ...
    seo: {
      title: 'Remove EXIF Data - Private Metadata Stripper',
      metaDescription: 'Remove GPS and camera metadata from photos instantly. 100% local processing protects your location privacy.',
      faq: [
        { q: 'What is EXIF data?', a: 'EXIF data includes metadata like camera settings, GPS location, date taken, and device information.' },
        { q: 'Why should I remove EXIF data?', a: 'Removing EXIF protects your privacy by stripping location data and device information before sharing.' },
        { q: 'Does this affect image quality?', a: 'No, removing metadata does not affect the visible image quality.' },
        { q: 'Can I preview EXIF data before removing?', a: 'Yes, the tool shows you what metadata exists before you remove it.' },
        { q: 'Are my images uploaded?', a: 'No, all processing happens locally in your browser.' },
      ],
    },
  },
  {
