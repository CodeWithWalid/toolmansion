...
export const TOOLS: ToolDefinition[] = [
  ...
  // === TEXT TOOLS ===
  {
    ...
    seo: {
      ...
      faq: [
        { q: 'What text statistics does the word counter provide?', a: 'Our word counter provides comprehensive statistics: word count (total words), character count with spaces, character count without spaces, sentence count, paragraph count, and estimated reading time based on average adult reading speed (200-250 words per minute). You also get average words per sentence for readability analysis.' },
        { q: 'Does the word counter update in real-time as I type?', a: 'Yes! All statistics update instantly as you type, paste, or edit text in the input area. There\'s no need to click a button or refresh — watch the numbers change character by character. This makes it perfect for hitting exact word counts while writing essays, articles, or social media posts.' },
        { q: 'Can I exclude certain words from the word count?', a: 'Currently, we count all words including common words like "the," "and," and "a." While there\'s no exclude feature yet, you can copy your text, remove the words you want to exclude, and count again. A custom exclude list feature is planned for future updates.' },
        { q: 'Is there a character or word limit for the counter?', a: 'There are no artificial limits. You can paste or type extremely long documents — novels, dissertations, lengthy reports. The practical limit depends on your browser\'s performance. Most users can count hundreds of thousands of words without issues. Very large documents (500,000+ words) may experience slight delays in updating.' },
        { q: 'Is my text stored or sent to any server?', a: 'Absolutely not. All text processing happens locally in your browser using JavaScript. Your text is never transmitted to any server, stored in any database, or logged anywhere. This ensures complete privacy for sensitive documents, confidential writing, and personal content. You can even disconnect from the internet after loading the page.' },
        { q: 'How accurate is the reading time estimate?', a: 'Reading time is calculated based on the average adult reading speed of 200-250 words per minute for comprehension. This works well for general articles and blog posts. Technical documents, academic papers, or dense literature may take longer. The estimate serves as a good guideline for content planning and audience expectations.' },
        { q: 'Can I check my text against social media character limits?', a: 'Yes! Our word counter includes visual indicators showing how your text fits within common platform limits: Twitter/X (280 characters), Instagram captions (2,200 characters), LinkedIn posts (3,000 characters), and more. Green means you\'re within limits; red means you need to trim your text.' },
        { q: 'What counts as a word in the word counter?', a: 'A word is defined as any sequence of characters separated by whitespace (spaces, tabs, line breaks). Hyphenated words like "well-known" count as one word. Numbers ("123") count as words. Email addresses and URLs count as single words if not separated by spaces. Contractions like "don\'t" and "it\'s" count as single words.' },
      ],
    },
  },
  {
  ...
  // === DEVELOPER TOOLS ===
  {
    ...
    seo: {
      ...
      faq: [
        { q: 'Does the JSON formatter validate JSON syntax?', a: 'Yes! The tool validates your JSON in real-time and highlights any syntax errors with detailed error messages including line numbers. Common errors detected include missing brackets, trailing commas, unquoted keys, invalid escape sequences, and incorrect data types. This helps you quickly identify and fix JSON formatting issues.' },
        { q: 'Can I minify JSON with this tool?', a: 'Yes! You can switch between beautified (formatted with indentation and line breaks) and minified (compact, single-line) views. Minified JSON is useful for production environments where file size matters, such as API responses, configuration files, or embedding in URLs. The minify option removes all unnecessary whitespace while preserving data integrity.' },
        { q: 'Is syntax highlighting available for JSON?', a: 'Yes, the formatter provides color-coded syntax highlighting that makes JSON easier to read. Keys are shown in one color, strings in another, numbers in a third, and booleans/null values in their own colors. This visual distinction helps you quickly understand the structure and spot data types at a glance.' },
        { q: 'Can I edit JSON directly in the formatter?', a: 'Yes! You can paste JSON, edit it directly in the text area, and re-format as needed. Make changes, click the Format button, and see the beautified result instantly. This makes it perfect for debugging API responses, editing configuration files, or cleaning up exported data.' },
        { q: 'Is my JSON data stored or sent to any server?', a: 'No, never. All JSON formatting and validation happens locally in your browser using JavaScript. Your data is never transmitted to any server, stored in any database, or logged anywhere. This makes it completely safe to format JSON containing API keys, personal data, or proprietary business information.' },
        { q: 'What JSON standards does the formatter support?', a: 'Our formatter follows RFC 8259, the official JSON specification. It supports all standard JSON data types: objects, arrays, strings, numbers (including scientific notation), booleans (true/false), and null. The tool also handles edge cases like empty objects, empty arrays, and deeply nested structures. JSON5 and JSONC (JSON with comments) are supported with comment stripping.' },
        { q: 'What are common JSON errors the formatter detects?', a: 'Common errors detected include: trailing commas (not allowed in standard JSON), unquoted object keys, single quotes instead of double quotes for strings, missing closing brackets or braces, unescaped special characters in strings, and invalid escape sequences. Each error is reported with a helpful message indicating what needs to be fixed.' },
        { q: 'Can the formatter handle large JSON files?', a: 'Yes, the formatter can handle JSON files of significant size, typically several megabytes. The practical limit depends on your browser\'s memory. For extremely large JSON files (10MB+), you may experience some delay in formatting, but the tool should handle them successfully. For production use with very large datasets, consider command-line tools.' },
      ],
    },
  },
  {
